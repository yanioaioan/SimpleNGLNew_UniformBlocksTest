...
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile SimpleNGL.pro
#############################################################################
...
DISTDIR = /home/yioannidis/NGLDemos/15-16/SimpleNGLNew/obj/SimpleNGL1.0.0
LINK          = g++
...
OBJECTS       = obj/NGLScene.o \
		obj/main.o \
		obj/moc_NGLScene.o
DIST          = SimpleNGL.pro include/NGLScene.h src/NGLScene.cpp \
		src/main.cpp
...
Makefile: SimpleNGL.pro .qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-g++/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile SimpleNGL.pro
...
moc/moc_NGLScene.cpp: /home/yioannidis/NGL/include/ngl/Camera.h \
		...
		include/NGLScene.h
	/opt/qt/5.5/gcc_64/bin/moc $(DEFINES) -I/opt/qt/5.5/gcc_64/mkspecs/linux-g++ -I/home/yioannidis/NGLDemos/15-16/SimpleNGLNew -I/home/yioannidis/NGLDemos/15-16/SimpleNGLNew/include -I/home/yioannidis/NGL/include -I/opt/qt/5.5/gcc_64/include -I/opt/qt/5.5/gcc_64/include/QtOpenGL -I/opt/qt/5.5/gcc_64/include/QtWidgets -I/opt/qt/5.5/gcc_64/include/QtGui -I/opt/qt/5.5/gcc_64/include/QtCore include/NGLScene.h -o moc/moc_NGLScene.cpp
